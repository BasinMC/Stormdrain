...
/**
 * Represents an event which notifies its receivers of the creation, deletion, modification or
 * change in visibility of a repository.
 *
 * @author <a href="mailto:johannesd@torchmind.com">Johannes Donath</a>
 */
public class RepositoryEvent extends AbstractRepositoryEvent {
  ...
  public boolean equals(Object o) {
    ...
    RepositoryEvent that = (RepositoryEvent) o;
